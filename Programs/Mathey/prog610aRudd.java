...
import java.io.*;
/**
 * Program: Prog610aRuddForMatheyRudd
 * @Version: 2.0
 ...
 * Desciption: This program read from prog610a.dat, which then calculates the area of a triagle with that and 
 deturmands if or it is not a traingle, this uses the matheyRudd class for finding a area.
 * 
 * What I Learned: How to create a new math class
 * 
 * Difficulties: 
 * 
 */
...
{
    static Scanner file = null;//need this here, otherwise fails to compile, stuck at the try statment.
    ...
    public static void triangleArea( int a, int b, int c )//method for calculating area
    {
        ...
        double area= mathy.squareRoot(x);//final step in formula, dont try and mix these otherwise you risk getting incorrect results
